...
public class SecondActivity extends AppCompatActivity {
    ...
    public void Add(){
        ...
        txt3.setText("Addition Is : "+ String.valueOf(result));
    ...
    public void Substract(){
        ...
        int num2 = Integer.parseInt(txt2.getText().toString());
        int result = num1 - num2;
        txt3.setText("Substraction Is : "+ String.valueOf(result));
    ...
    public void Multiple(){
        ...
        int num2 = Integer.parseInt(txt2.getText().toString());
        int result = num1 * num2;
        txt3.setText("Multification Is : "+ String.valueOf(result));
    ...
    public void Divition(){
        ...
        int num2 = Integer.parseInt(txt2.getText().toString());
        int result = num1 / num2;
        txt3.setText("Divition Is : "+ String.valueOf(result));
